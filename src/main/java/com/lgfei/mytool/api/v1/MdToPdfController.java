...
import com.lgfei.mytool.converter.MdToPdfConverter;
...
public class MdToPdfController {
    ...
    @Value("${mytool.file.storage.mdtopdf:/data/files/mytool/mdtopdf/}")
    ...
    public ResponseEntity<Resource> downloadResume(){
        ...
        try {
            ...
            mdFilePath = CODE_DIR + currTime + File.separator + "resume" + File.separator + "resume.md";
        }
